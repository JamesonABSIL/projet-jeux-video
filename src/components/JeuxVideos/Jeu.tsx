...
import { findByName, findBySlug } from '../../store/selectors/findData';
          ...
          <div className="card lg:card-side bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                  ...
                  <li key={parties.id} className="items-center gap-x-10 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    ...
                    {parties.status != 'finished' && (
                      <Link to={`/parties/${parties.id}`}>
                        Partie n°{parties.id} le {formatedDate(parties.beginAt)}{' '}
                        sur {parties.platform.name}{' '}
              ...
              <div className="card-actions justify-end">
                <Link to="/jeux">
                  <button className="btn z-50">Revenir aux jeux</button>
                </Link>
                <aside
                  className={
                    open
                ...
                >
                  {open ? (
                    <button
                      className="btn btn-outline btn-success z-40 bg-black"
                      onClick={handleClick}
                    >
                      Créer une partie
                    </button>
                    ...
                    <button
                      className="btn btn-outline btn-error z-40 bg-black"
                      onClick={handleClick}
                    >
                      X
                    </button>
