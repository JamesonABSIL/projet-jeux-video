...
import { changeDateinput, changeGameInput, changeParticipantNumberinput, changePlatformInput, joinAGame, updateGame, updateGameStatus, } from '../../store/reducer/games';
  ...
  return (
    <>
      {!partie ? (
        ...
        <div>
          ...
          <div className="card lg:card-side bg-base-100 shadow-xl flex justify-center">
            <div className='flex'>
              <figure className= {isDesktopOrLaptop ? ' h-full w-full ' : 'h-auto w-content '}>
                <img
              ...
              <div className="card-body">
                ...
                <ul>
                  ...
                  <li key={p.pseudo}>{p.pseudo} - {renderSwitch(partie.platform.name, p)}   
                ...
                {partie.countParticipants >= partie.maxParticipants ? (
                  ...
                  <div className="card-actions justify-end">
                    ...
                    <button className={partie.organizer.id===currentUser.id ? "hidden" :"btn btn-primary"  } onClick={handleClick}>
                ...
                {partie.organizer.id===currentUser.id && partie.status!="finished" && <button className='btn btn-primary' onClick={() => handleSetStatus(partie.id)}>Marquer la partie comme terminée</button>}
      ...
      >
        ...
        {open ?
          <button className="btn btn-outline btn-success z-50 bg-black" onClick={handleClicke}>
          Modifier 
          </button>
          : <button className="btn btn-outline btn-error z-50 bg-black" onClick={handleClicke}>
          X
        </button>}
